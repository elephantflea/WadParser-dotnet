...
namespace nz.doom.WadParser
{
    ...
    public class WadParser
    {
        ...
        /// <summary>
        /// Parse the given WAD file located at <paramref name="wadPath"/> into a <see cref="Wad"/> object.
        /// </summary>
        ...
        public static Wad Parse(string wadPath)
        {
            if (wadPath == null)
            {
            ...
            using (FileStream wadFileStream = File.OpenRead(wadPath))
            {
                ...
                var wad = new Wad(wadPath, (int)wadFileStream.Length, Path.GetFileName(wadFileStream.Name));
                wad.WadType = wadType;
